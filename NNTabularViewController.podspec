#
# Be sure to run `pod lib lint NNTabularViewController.podspec' to ensure this is a
...
TODO: Add long description of the pod here.
  ...
  s.source_files = 'NNTabularViewController/Classes/**/*'
  
  # s.resource_bundles = {
  #   'NNTabularViewController' => ['NNTabularViewController/Assets/*.png']
  # }
